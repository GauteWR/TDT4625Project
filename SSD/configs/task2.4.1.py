# Inherit configs from the ssd128x1024
import torchvision
from ssd.data import TDT4265Dataset
from tops.config import LazyCall as L
from ssd.data.transforms import (
    ToTensor, Normalize, Resize, RandomSampleCrop, RandomHorizontalFlip,
    GroundTruthBoxesToAnchors)
from .ssd128Imp24IoU import train, anchors, optimizer, schedulers, backbone, model, data_train, data_val, loss_objective
...
train_cpu_transform = L(torchvision.transforms.Compose)(transforms=[
    ...
    L(GroundTruthBoxesToAnchors)(anchors="${anchors}", iou_threshold=0.4),
])
